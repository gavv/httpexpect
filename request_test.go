...
func TestRequest_Order(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			prepFunc: func(req *Request) *Request {
				return req.WithPathObject(map[string]string{"repo": "repo1"})
			},
		},
		{
		...
		},
		{
			...
			prepFunc: func(req *Request) *Request {
				return req.WithQueryObject(map[string]string{"a": "val"})
			},
		},
		{
		...
		},
		{
			...
			prepFunc: func(req *Request) *Request {
				return req.WithCookies(map[string]string{"key1": "val1"})
			},
		},
		{
		...
		},
		{
			...
			prepFunc: func(req *Request) *Request {
				return req.WithJSON(map[string]string{"key1": "val1"})
			},
		},
		{
			name: "WithForm after Expect",
			prepFunc: func(req *Request) *Request {
				return req.WithForm(map[string]string{"key1": "val1"})
			},
		},
		{
